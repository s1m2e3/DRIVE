...
if __name__ == '__main__':
    ...
    client = Client()
    client.geofencer.add_geofences(args.config_geofences)
    print("Geofences configuration read and initialized")
    client.add_registration_receiver(args.config_communication)
    print("Communication configuration read and initialized")
